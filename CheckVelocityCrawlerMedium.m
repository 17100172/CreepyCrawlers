function [ Crawler ] = CheckVelocityCrawlerMedium( Crawler, Bus, grid )
randN = randi(6);
%% Assign a Velocity that makes the Crawler move towards the Bus by a Probability of 4/6
if randN <= 4;
...
%% Assign a Velocity that makes the Crawler move Randomly by a Probability of 2/6     
